...
@SuppressWarnings("unused") public class AvatarImageBehavior
	...
	@Override public boolean layoutDependsOn(CoordinatorLayout parent, CircleImageView child,
		View dependency) {

		return dependency instanceof Toolbar;
	}

	@Override public boolean onMeasureChild(CoordinatorLayout parent, CircleImageView child,
	...
	@Override public boolean onDependentViewChanged(CoordinatorLayout parent, CircleImageView child,
		...
		lp.setMargins((int) pChildMarginLeft + extraFinalPadding,
			(int) childMarginTop + extraFinalPadding, lp.rightMargin, lp.bottomMargin);
