...
@SuppressWarnings("unused") public class ActionItemsBehavior
	...
	public ActionItemsBehavior(Context context, AttributeSet attrs) {
		mContext = context;
		init();
	}
	...
	@Override public boolean layoutDependsOn(CoordinatorLayout parent, ImageView child,
		View dependency) {
		return dependency instanceof Toolbar;
	}

	@Override public boolean onMeasureChild(CoordinatorLayout parent, ImageView child,
		int parentWidthMeasureSpec, int widthUsed, int parentHeightMeasureSpec, int heightUsed) {
		return super.onMeasureChild(parent, child, parentWidthMeasureSpec, widthUsed,
			parentHeightMeasureSpec, heightUsed);
	}

	@Override public boolean onDependentViewChanged(CoordinatorLayout parent, ImageView child,
		View dependency) {
		...
		lp.setMargins(lp.leftMargin,
			(int) childMarginTop + extraFinalPadding, (int) pChildMarginLeft + extraFinalPadding, lp.bottomMargin);
