package com.panwrona.myportfolio.customviews.pull_to_refresh;
...
/**
 * Created by mariusz on 02.09.15.
 */
public class AnimationView extends View {
	...
	private void initView(Context context, AttributeSet attrs, int defStyleAttr) {
		...
		PULL_HEIGHT = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 100,
	...
	private void drawDone(Canvas canvas) {
		...
		if (getDoneRatio() < 0.3) {
			...
			int afterColor = Color.argb((int) (0xff * (1 - getDoneRatio() / 0.3f)),
				Color.red(beforeColor), Color.green(beforeColor), Color.blue(beforeColor));
