...
import com.panwrona.myportfolio.screen_about_me.AboutMePagerAdapter;
...
public class CodingActivity extends MvpActivity<CodingView, CodingPresenter>
        implements CodingView, ViewTreeObserver.OnGlobalLayoutListener, AppBarLayout.OnOffsetChangedListener {
    ...
    @Bind(R.id.activity_coding_toolbar)
    Toolbar mToolbar;
    @Bind(R.id.activity_coding_appbar)
    AppBarLayout mAppBar;
    @Bind(R.id.activity_coding_cl_main_layout)
    CoordinatorLayout mClMainLayout;
    @Bind(R.id.activity_coding_vp_container)
    ViewPager mVpContainer;
    @Bind(R.id.activity_coding_tl_container)
    TabLayout mTlContainer;
    @Bind(R.id.activity_coding_nsv_container)
    ...
    private void initViews() {
        ...
        CodingPagerAdapter pagerAdapter =
                new CodingPagerAdapter(getSupportFragmentManager());
    ...
    private void setupEnterTransition() {
        GUIUtils.startEnterTransitionSlideUp(this, mNsvContainer);
